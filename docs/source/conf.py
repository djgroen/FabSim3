...
html_theme_options = {
    ...
    #    'headbgcolor': '#C71585', 'sidebarbgcolor':
    #'#C71585', 'relbarbgcolor': '#C71585', 'footerbgcolor': '#C71585',
    # u'bgcolor': u'#C71585', 'footertextcolor': 'white'
}
...
latex_documents = [
    (master_doc, 'FabSim3.tex', 'FabSim3 Documentation',
     'Derek Groen', 'manual'),
]
