...
cd /home/hamid/Downloads/FabSim3_refactor/localhost_exe/FabSim3/results/mali_localhost_16_vvp_QoI_PCESampler_PO2/RUNS/run_2
/bin/true || true
...
rsync -pthrvz $config_dir/SWEEP/run_2/ .
