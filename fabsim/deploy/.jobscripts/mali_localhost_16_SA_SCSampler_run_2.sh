...
cd /home/hamid/Downloads/FabSim3_refactor/localhost_exe/FabSim3/results/mali_localhost_16_SA_SCSampler/RUNS/run_2
/bin/true || true

# copy files from config folder
config_dir=/home/hamid/Downloads/FabSim3_refactor/localhost_exe/FabSim3/config_files/mali_SA_SCSampler
