...
cd /home/hamid/Downloads/FabSim3_refactor/localhost_exe/FabSim3/results/validation_localhost_4/RUNS/oldstyle_burundi
/bin/true || true
...
rsync -pthrvz $config_dir/SWEEP/oldstyle_burundi/ .
