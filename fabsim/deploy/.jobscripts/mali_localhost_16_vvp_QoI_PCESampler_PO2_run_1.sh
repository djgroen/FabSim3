...
cd /home/hamid/Downloads/FabSim3_refactor/localhost_exe/FabSim3/results/mali_localhost_16_vvp_QoI_PCESampler_PO2/RUNS/run_1
/bin/true || true

# copy files from config folder
config_dir=/home/hamid/Downloads/FabSim3_refactor/localhost_exe/FabSim3/config_files/mali_vvp_QoI_PCESampler_PO2
rsync -pthrvz --exclude SWEEP $config_dir/* .

# copy files from SWEEP folder
rsync -pthrvz $config_dir/SWEEP/run_1/ .
