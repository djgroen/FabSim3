...
def test_fabdummy_install():
    assert (
        subprocess.call(["fabsim", "localhost", "install_plugin:FabDummy"])
        == 0
    )
    ...
    assert (
        subprocess.call(
            [
                "fabsim",
                "localhost",
                "dummy:dummy_test,replicas=5,nb_process=2,manual_ssh=false",
            ]
        )
        == 0
    )
    ...
    assert (
        subprocess.call(
            [
                "fabsim",
                "localhost",
                "dummy:dummy_test,replicas=5,nb_process=2,manual_ssh=true",
            ]
        )
        == 0
    )
    ...
    assert (
        subprocess.call(
            [
                "fabsim",
                "localhost",
                "dummy_ensemble:dummy_test,nb_process=2,manual_ssh=false",
            ]
        )
        == 0
    )
    ...
    assert (
        subprocess.call(
            [
                "fabsim",
                "localhost",
                "dummy_ensemble:dummy_test,nb_process=2,manual_ssh=true",
            ]
        )
        == 0
    )
    ...
    assert (
        subprocess.call(
            [
                "fabsim",
                "localhost",
                "dummy_ensemble:dummy_test,replicas=5,nb_process=2,manual_ssh=false",
            ]
        )
        == 0
    )
    ...
    assert (
        subprocess.call(
            [
                "fabsim",
                "localhost",
                "dummy_ensemble:dummy_test,replicas=5,nb_process=2,manual_ssh=true",
            ]
        )
        == 0
    )
